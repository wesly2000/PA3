...
python exp/dataset_process/data_augmentation_dywin.py -i ${root_dir}/vmess/raw.npz -o ${root_dir}/vmess/raw_dywin.npz

python exp/dataset_process/data_augmentation_dywin.py -i ${root_dir}/shadowsocks/raw.npz -o ${root_dir}/shadowsocks/raw_dywin.npz

python exp/dataset_process/data_augmentation_dywin.py -i ${root_dir}/trojan/raw.npz -o ${root_dir}/trojan/raw_dywin.npz

gen_all_transforms ${root_dir}/vmess/raw_dywin.npz

gen_all_transforms ${root_dir}/shadowsocks/raw_dywin.npz

gen_all_transforms ${root_dir}/trojan/raw_dywin.npz
