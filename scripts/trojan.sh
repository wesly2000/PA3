...
i=1
while [ "$i" -le "$iter_num" ]; do
    rm_dir_if_exists "${root_dir}/workspace/trojan_${model_feature}_bs_filter_${coverage}/${model}"

    ./scripts/${model}.sh ${root_dir}/workspace/trojan_${model_feature}_bs_filter_${coverage} ${model_feature} cuda:0
    ./scripts/${model}_test.sh ${root_dir}/workspace/trojan_${model_feature}_bs_filter_${coverage} ${root_dir}/workspace/vmess_${model_feature}_bs_filter_${coverage} ${model_feature} cuda:0 
    ./scripts/${model}_test.sh ${root_dir}/workspace/trojan_${model_feature}_bs_filter_${coverage} ${root_dir}/workspace/shadowsocks_${model_feature}_bs_filter_${coverage} ${model_feature} cuda:0 
    i=$((i + 1))
done
...
i=1
while [ "$i" -le "$iter_num" ]; do
    rm_dir_if_exists "${root_dir}/workspace/trojan_${model_feature}_bs_filter_strip_${coverage}/${model}"

    ./scripts/${model}.sh ${root_dir}/workspace/trojan_${model_feature}_bs_filter_strip_${coverage} ${model_feature} cuda:0
    ./scripts/${model}_test.sh ${root_dir}/workspace/trojan_${model_feature}_bs_filter_strip_${coverage} ${root_dir}/workspace/vmess_${model_feature}_bs_filter_strip_${coverage} ${model_feature} cuda:0 
    ./scripts/${model}_test.sh ${root_dir}/workspace/trojan_${model_feature}_bs_filter_strip_${coverage} ${root_dir}/workspace/shadowsocks_${model_feature}_bs_filter_strip_${coverage} ${model_feature} cuda:0 
    i=$((i + 1))
done
...
split_feature=size
copy_npz_if_missing ${root_dir}/features/trojan/${file_feature}_bs_filter_strip_${coverage}.npz ${root_dir}/workspace/trojan_${model_feature}_bs_filter_strip_${coverage}.npz
copy_npz_if_missing ${root_dir}/features/trojan/${file_feature}_bs_filter_strip_${coverage}_aug_slope_shadowsocks.npz ${root_dir}/workspace/trojan_${model_feature}_bs_filter_strip_${coverage}_aug_slope_shadowsocks.npz
copy_npz_if_missing ${root_dir}/features/trojan/${file_feature}_bs_filter_strip_${coverage}_aug_slope_vmess.npz ${root_dir}/workspace/trojan_${model_feature}_bs_filter_strip_${coverage}_aug_slope_vmess.npz
copy_npz_if_missing ${root_dir}/features/vmess/${file_feature}_bs_filter_strip_${coverage}.npz ${root_dir}/workspace/vmess_${model_feature}_bs_filter_strip_${coverage}.npz
copy_npz_if_missing ${root_dir}/features/shadowsocks/${file_feature}_bs_filter_strip_${coverage}.npz ${root_dir}/workspace/shadowsocks_${model_feature}_bs_filter_strip_${coverage}.npz

# Merge Trojan datasets
python exp/dataset_process/dataset_merge.py \
-i ${root_dir}/workspace/trojan_${model_feature}_bs_filter_strip_${coverage}.npz \
${root_dir}/workspace/trojan_${model_feature}_bs_filter_strip_${coverage}_aug_slope_shadowsocks.npz \
${root_dir}/workspace/trojan_${model_feature}_bs_filter_strip_${coverage}_aug_slope_vmess.npz \
-o ${root_dir}/workspace/trojan_${model_feature}_bs_filter_strip_${coverage}_aug_slope.npz

python exp/dataset_process/dataset_split.py -f ${split_feature} --dataset ${root_dir}/workspace/trojan_${model_feature}_bs_filter_strip_${coverage}_aug_slope
python exp/dataset_process/dataset_split.py -f ${split_feature} --dataset ${root_dir}/workspace/shadowsocks_${model_feature}_bs_filter_strip_${coverage}
python exp/dataset_process/dataset_split.py -f ${split_feature} --dataset ${root_dir}/workspace/vmess_${model_feature}_bs_filter_strip_${coverage}

i=1
while [ "$i" -le "$iter_num" ]; do
        rm_dir_if_exists "${root_dir}/workspace/trojan_${model_feature}_bs_filter_strip_${coverage}_aug_slope/${model}"

    ./scripts/${model}.sh ${root_dir}/workspace/trojan_${model_feature}_bs_filter_strip_${coverage}_aug_slope ${model_feature} cuda:0
    ./scripts/${model}_test.sh ${root_dir}/workspace/trojan_${model_feature}_bs_filter_strip_${coverage}_aug_slope ${root_dir}/workspace/vmess_${model_feature}_bs_filter_strip_${coverage} ${model_feature} cuda:0 
    ./scripts/${model}_test.sh ${root_dir}/workspace/trojan_${model_feature}_bs_filter_strip_${coverage}_aug_slope ${root_dir}/workspace/shadowsocks_${model_feature}_bs_filter_strip_${coverage} ${model_feature} cuda:0 
    i=$((i + 1))
done

rm_file_if_exists ${root_dir}/workspace/trojan_${model_feature}_bs_filter_strip_${coverage}_aug_slope_vmess.npz 
rm_file_if_exists ${root_dir}/workspace/trojan_${model_feature}_bs_filter_strip_${coverage}_aug_slope_shadowsocks.npz
rm_file_if_exists ${root_dir}/workspace/trojan_${model_feature}_bs_filter_strip_${coverage}_aug_slope.npz 
rm_file_if_exists ${root_dir}/workspace/trojan_${model_feature}_bs_filter_strip_${coverage}.npz 
rm_file_if_exists ${root_dir}/workspace/vmess_${model_feature}_bs_filter_strip_${coverage}.npz
rm_file_if_exists ${root_dir}/workspace/shadowsocks_${model_feature}_bs_filter_strip_${coverage}.npz 

rm_dir_if_exists ${root_dir}/workspace/trojan_${model_feature}_bs_filter_strip_${coverage}_aug_slope 
rm_dir_if_exists ${root_dir}/workspace/vmess_${model_feature}_bs_filter_strip_${coverage} 
rm_dir_if_exists ${root_dir}/workspace/shadowsocks_${model_feature}_bs_filter_strip_${coverage} 