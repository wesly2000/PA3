...
for _cfg_row in "${MODEL_CONFIGS[@]}"; do
    ...
    copy_npz_if_missing "${root_dir}/features/vmess/${file_feature}_bs_filter_strip_${coverage}_aug_cdf.npz" "${root_dir}/workspace/vmess_${model_feature}_bs_filter_strip_${coverage}_aug.npz"
    ...
    python exp/dataset_process/dataset_split.py -f ${split_feature} --dataset ${root_dir}/workspace/vmess_${model_feature}_bs_filter_strip_${coverage}_aug_cdf

    for ((i=1; i<=iter_num; i++)); do
        rm_dir_if_exists "${root_dir}/workspace/vmess_${model_feature}_bs_filter_strip_${coverage}_aug_cdf/${model}"
        rm_dir_if_exists "${root_dir}/workspace/merge_${model_feature}_bs_filter_strip_${coverage}_aug_cdf/${model}"

        ./scripts/${model}.sh ${root_dir}/workspace/merge_${model_feature}_bs_filter_strip_${coverage}_aug_cdf ${model_feature} cuda:0 ${root_dir}/workspace/vmess_${model_feature}_bs_filter_strip_${coverage}_aug_cdf
        ./scripts/${model}_test.sh ${root_dir}/workspace/merge_${model_feature}_bs_filter_strip_${coverage}_aug_cdf ${root_dir}/workspace/shadowsocks_${model_feature}_bs_filter_strip_${coverage} ${model_feature} cuda:0
        ./scripts/${model}_test.sh ${root_dir}/workspace/merge_${model_feature}_bs_filter_strip_${coverage}_aug_cdf ${root_dir}/workspace/trojan_${model_feature}_bs_filter_strip_${coverage} ${model_feature} cuda:0
    done

    rm_file_if_exists "${root_dir}/workspace/merge_${model_feature}_bs_filter_strip_${coverage}_aug_cdf.npz"
    rm_file_if_exists "${root_dir}/workspace/vmess_${model_feature}_bs_filter_strip_${coverage}_aug_cdf.npz"
    ...
    rm_dir_if_exists "${root_dir}/workspace/merge_${model_feature}_bs_filter_strip_${coverage}_aug_cdf"
