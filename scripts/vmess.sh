...
for _cfg_row in "${MODEL_CONFIGS[@]}"; do
    ...
    python /home/lxyu/Reproduction/WFLib/exp/dataset_process/dataset_merge.py -i "${root_dir}/workspace/vmess_${model_feature}_bs_filter_strip_${coverage}.npz" "${root_dir}/workspace/vmess_${model_feature}_bs_filter_strip_${coverage}_aug.npz" -o "${root_dir}/workspace/merge_${model_feature}_bs_filter_strip_${coverage}.npz"
    ...
    for ((i=1; i<=iter_num; i++)); do
        rm_dir_if_exists "${root_dir}/workspace/merge_${model_feature}_bs_filter_strip_${coverage}/${model}"
    ...
    rm_file_if_exists "${root_dir}/workspace/merge_${model_feature}_bs_filter_strip_${coverage}.npz"
    ...
    rm_dir_if_exists "${root_dir}/workspace/merge_${model_feature}_bs_filter_strip_${coverage}"
