...
for protocol in "${protocols[@]}"; do
    python exp/dataset_process/data_augmentation_netrand.py -i ${PA3_REPO_ROOT}/Reproduce/features/${protocol}/raw.npz -o ${PA3_REPO_ROOT}/Reproduce/features/${protocol}/raw_netrand.npz
